...
public class wishlist_read extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wishlist_read);
        mapView = (MapView) findViewById(R.id.wish_map_view);
        sale_read_logo = (TextView) findViewById(R.id.wish_read_logo);
        linearMap = (LinearLayout) findViewById(R.id.wish_linear);
        like_btn = (CompoundButton) findViewById(R.id.wish_read_like_btn);

        Intent getIntent = getIntent();

        String getPost_authNum = getIntent.getStringExtra("post_authNum");

        spinner = (Spinner) findViewById(R.id.wish_read_spinner);
        ...
        while(it_val.hasNext()) {
            ...
            try {
                ...
                String authNums = jsonObject.getString("authNum");

                Call<String> isWish = retrofit_basic.check_wish(authNums,getPost_authNum);
                ...
                like_btn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                        ...
                        Call<String> update_like = retrofit_basic.update_like(authNums,getPost_authNum);
                        update_like.enqueue(new Callback<String>() {
                            @Override
                            public void onResponse(Call<String> call, Response<String> response) {
                                if(response.isSuccessful() && response.body() != null) {
                                    Toast.makeText(wishlist_read.this, response.body(), Toast.LENGTH_SHORT).show();
                                }
                            }
                    ...
                    for(int i = 0; i < co_list.size(); i++) {
                        ...
                        if(latitude != 0 && longitude != 0) {
                            ...
                            if(mapFragment == null) {
                                ...
                                fm.beginTransaction().add(R.id.wish_map_view,mapFragment).commit();
                                mapFragment.getMapAsync(wishlist_read.this);
        ...
        viewPager2 = (ViewPager2) findViewById(R.id.wish_read_viewpager);
        indicator = (LinearLayout) findViewById(R.id.wish_layout_indicator);


        profile_image = (ImageView) findViewById(R.id.wish_read_profile_image);
        profile_name = (TextView) findViewById(R.id.wish_read_name);
        profile_address = (TextView) findViewById(R.id.wish_read_address);
        tv_title = (TextView) findViewById(R.id.wish_read_title);
        tv_description = (TextView) findViewById(R.id.wish_read_description);
        tv_price = (TextView) findViewById(R.id.wish_read_price);
        tv_like_num = (TextView) findViewById(R.id.wish_read_like_num);
        tv_chat_num = (TextView) findViewById(R.id.wish_read_chat_num);
        tv_hit_num = (TextView) findViewById(R.id.wish_read_hit_num);
        tv_category = (TextView) findViewById(R.id.wish_read_category);
        tv_time = (TextView) findViewById(R.id.wish_read_date);
        menu = (ImageButton) findViewById(R.id.wish_menu);

        chat = (Button) findViewById(R.id.wish_read_chat_btn);
                ...
                if(!authNum.equals(authNum) ) {
                    ...
                    menu.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            PopupMenu popup = new PopupMenu(wishlist_read.this,menu);
                                ...
                                public boolean onMenuItemClick(MenuItem menuItem) {
                                    ...
                                    switch (menuItem.getItemId()) {
                                        ...
                                        case R.id.edit_post :
                                            ...
                                            Intent intent = new Intent(wishlist_read.this,edit_sale_post.class);
                                        ...
                                        case R.id.delete_post :
                                            ...
                                            AlertDialog.Builder builder = new AlertDialog.Builder(wishlist_read.this);
                                            ...
                                            builder.setPositiveButton("삭제", new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialogInterface, int i) {
                                                    ...
                                                    del_call.enqueue(new Callback<String>() {
                                                        ...
                                                        public void onResponse(Call<String> call, Response<String> response) {
                                                            if(response.isSuccessful() && response.body() != null) {
                                                                Intent intent = new Intent(wishlist_read.this,MainActivity.class);
                                                                startActivity(intent);
                                                                finish();
...
//                            popup.dismiss();
        ...
        req_image.enqueue(new Callback<List<multipleImage>>() {
            ...
            public void onResponse(Call<List<multipleImage>> call, Response<List<multipleImage>> response) {
                if(response.isSuccessful() && response.body() != null) {
                    ...
                    adapter = new ImageSliderAdapter(wishlist_read.this,uri_list);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(wishlist_read.this,wishlist.class);
