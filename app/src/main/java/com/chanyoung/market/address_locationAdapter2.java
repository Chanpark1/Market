...
public class address_locationAdapter2 extends RecyclerView.Adapter<address_locationAdapter2.CustomViewHolder> {
    ...
    public address_locationAdapter2(Context mContext,List<locationItem2> list) {
    ...
    @NonNull
    @Override
    public address_locationAdapter2.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull address_locationAdapter2.CustomViewHolder holder, int position) {
            ...
            public void onClick(View view) {
                ...
                while(it_val.hasNext() && it_key.hasNext()) {
                    ...
                    try {
                        ...
                        Call<String> call = retrofit_update_location.insertAddress(authNum,area,area4,longitude,latitude);
