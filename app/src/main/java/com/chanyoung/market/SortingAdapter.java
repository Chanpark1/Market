...
public class SortingAdapter extends RecyclerView.Adapter<SortingAdapter.CustomViewHolder> {

    private Context context;
    private List<sortedItems> list;

    public SortingAdapter(Context context, List<sortedItems> list) {
    ...
    @NonNull
    @Override
    public SortingAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SortingAdapter.CustomViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(),sorted_post_read.class);
                ...
                ((Sort_by_category)context).finish();
