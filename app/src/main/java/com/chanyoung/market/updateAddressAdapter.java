...
public class updateAddressAdapter extends RecyclerView.Adapter<updateAddressAdapter.CustomViewHolder> {

    private List<locationItem> list;
    private Context mContext;

    public updateAddressAdapter(Context mContext, List<locationItem> list) {
        this.mContext = mContext;
        this.list = list;
    }
    @NonNull
    @Override
    public updateAddressAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull updateAddressAdapter.CustomViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<String> call = retrofit_update_address.updateAddress(authNum,area3,area4,longitude,latitude);
