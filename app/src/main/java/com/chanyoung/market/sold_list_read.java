...
public class sold_list_read extends AppCompatActivity implements OnMapReadyCallback {
                    ...
                    for(int i = 0; i < co_list.size(); i++) {
                        ...
                        if(latitude != 0 && longitude != 0) {
                            ...
                            if(mapFragment == null) {
                                ...
                                mapFragment.getMapAsync(sold_list_read.this);
            ...
            like_btn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    ...
                    update_like.enqueue(new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            if(response.isSuccessful() && response.body() != null) {
                                Toast.makeText(sold_list_read.this, response.body(), Toast.LENGTH_SHORT).show();
                            }
                        }
            ...
            if(!authNum.equals(auths) ) {
                ...
                menu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        PopupMenu popup = new PopupMenu(sold_list_read.this,menu);
                            ...
                            public boolean onMenuItemClick(MenuItem menuItem) {
                                ...
                                switch (menuItem.getItemId()) {
                                    ...
                                    case R.id.edit_post :
                                        ...
                                        Intent intent = new Intent(sold_list_read.this,edit_sale_post.class);
                                    ...
                                    case R.id.delete_post :
                                        ...
                                        AlertDialog.Builder builder = new AlertDialog.Builder(sold_list_read.this);
                                        ...
                                        builder.setPositiveButton("삭제", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialogInterface, int i) {
                                                ...
                                                del_call.enqueue(new Callback<String>() {
                                                    ...
                                                    public void onResponse(Call<String> call, Response<String> response) {
                                                        if(response.isSuccessful() && response.body() != null) {
                                                            Intent intent = new Intent(sold_list_read.this,MainActivity.class);
                                                            startActivity(intent);
                                                            finish();
...
//                            popup.dismiss();
                ...
                if(response.isSuccessful() && response.body() != null) {
                    ...
                    for(int i = 0; i < main_list.size(); i++) {
                        ...
                        if(profile_image_uri == null) {
                            Glide.with(sold_list_read.this)
                                    .load(url)
                                    .into(profile_image);
                        } else {
                            Glide.with(sold_list_read.this)
        ...
        req_image.enqueue(new Callback<List<multipleImage>>() {
            ...
            public void onResponse(Call<List<multipleImage>> call, Response<List<multipleImage>> response) {
                if(response.isSuccessful() && response.body() != null) {
                    ...
                    adapter = new ImageSliderAdapter(sold_list_read.this,uri_list);
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(sold_list_read.this,sold_list.class);
                startActivity(intent);
                finish();
            }
        });
