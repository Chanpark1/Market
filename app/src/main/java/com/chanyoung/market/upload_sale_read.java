...
public class upload_sale_read extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private List<Coordinates> co_list = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sold_iv = (ImageView) findViewById(R.id.read_sold_iv);
        sold_tv = (TextView) findViewById(R.id.read_sold_tv);

        chat = (Button) findViewById(R.id.sale_read_chat_btn);
        start_chat = (Button) findViewById(R.id.start_chat_btn);
        ...
        Retrofit_chatting chatting = retrofit.create(Retrofit_chatting.class);

        Call<String> chat2 = chatting.get_room_pk(getAuthNum(), auths,getPost_authNum);
        chat2.enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                if(response.isSuccessful() && response.body() != null) {
                    room_auth = response.body();
                    System.out.println("room auth" + room_auth);
                }
            }
        ...
        start_chat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(upload_sale_read.this, Chatting.class);



                String uri = uri_list.get(0).getPath();
                String status = getIntent.getStringExtra("status");
                String price = tv_price.getText().toString();
                String title = tv_title.getText().toString();
                intent.putExtra("post_authNum",getPost_authNum);
                intent.putExtra("authNum",auths);
                intent.putExtra("username",profile_name.getText().toString());
                intent.putExtra("postImage",uri);
                intent.putExtra("status",status);
                intent.putExtra("price",price);
                intent.putExtra("title",title);
//                intent.putExtra("room_auth", room_auth);
                System.out.println("Dasdsadasdsadfasd    " +  room_auth);

                intent.putExtra("temp",authNum);
                intent.putExtra("room_auth", room_auth);
                ...
                like_btn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                        ...
                        update_like.enqueue(new Callback<String>() {
                            ...
                            public void onResponse(Call<String> call, Response<String> response) {
                                if(response.isSuccessful() && response.body() != null) {
                                    Toast.makeText(upload_sale_read.this, response.body(), Toast.LENGTH_SHORT).show();
                    ...
                    for(int i = 0; i < co_list.size(); i++) {
                        ...
                        if(latitude != 0 && longitude != 0) {
                            ...
                            if(mapFragment == null) {
                                ...
                                mapFragment.getMapAsync(upload_sale_read.this);
        ...
        if(!auths.equals(authNum)) {
            ...
            menu.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    PopupMenu popup = new PopupMenu(upload_sale_read.this,menu);
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            switch (menuItem.getItemId()) {
                                ...
                                case R.id.read_report :
                                    Intent intent = new Intent(upload_sale_read.this,Report.class);
            ...
            sp_adapter = ArrayAdapter.createFromResource(upload_sale_read.this, R.array.post_status, androidx.appcompat.R.layout.support_simple_spinner_dropdown_item);
            ...
            if(st.equals("판매중")) {
                ...
                sold_iv.setVisibility(View.VISIBLE);
                sold_tv.setVisibility(View.VISIBLE);
            }
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            switch (menuItem.getItemId()) {
                                ...
                                case R.id.edit_post :
                                    ...
                                    Intent intent = new Intent(upload_sale_read.this,edit_sale_post.class);
                                ...
                                case R.id.delete_post :
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(upload_sale_read.this);
                                    ...
                                    builder.setPositiveButton("삭제", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            del_call.enqueue(new Callback<String>() {
                                                ...
                                                public void onResponse(Call<String> call, Response<String> response) {
                                                    if(response.isSuccessful() && response.body() != null) {
                                                        Intent intent = new Intent(upload_sale_read.this,MainActivity.class);
                                                        startActivity(intent);
                                                        finish();
                ...
                if(response.isSuccessful() && response.body() != null) {
                    ...
                    for(int i = 0; i < main_list.size(); i++) {
                        ...
                        if(profile_image_uri == null) {
                            Glide.with(upload_sale_read.this)
                                    .load(url)
                                    .into(profile_image);
                        } else {
                            Glide.with(upload_sale_read.this)
        ...
        req_image.enqueue(new Callback<List<multipleImage>>() {
            ...
            public void onResponse(Call<List<multipleImage>> call, Response<List<multipleImage>> response) {
                if(response.isSuccessful() && response.body() != null) {
                    ...
                    adapter = new ImageSliderAdapter(upload_sale_read.this,uri_list);
