...
public class postItem {
    @Expose
    @SerializedName("post_idx") private String post_idx;
    ...
    public postItem(String authNum, String post_idx, String post_authNum, String title, String price,
                    String description, String area, String like, String chat_num, String image_uri,
                    String tr_lat, String tr_lng, String hit_num, String status) {
